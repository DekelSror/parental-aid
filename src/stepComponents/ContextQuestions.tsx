import { Button, ButtonGroup, Checkbox, Collapse, Divider, FormControl, Input, Select, Stack, Typography, useMediaQuery } from '@mui/material'
import React, { useContext, useState } from 'react'
import { FamilyContext, WizardContext, answers } from '../store'
import { AddButton, DSlider, DSwitch, SelectInput, SelectItem, SelectLabel, StepContainer, colors } from '../styles'
